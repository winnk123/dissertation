...
class GridRunner(Runner):
    ...
    def run(self):
        ...
        # 手动打开 CSV 文件以追加数据
        #f = open('/home/chenyue001/Khattiya-Explore-Bench/src/onpolicy/onpolicy/runner/shared/test.csv', 'a')
            ...
            for step in range(self.max_steps):
                ...
                for e in range(self.n_rollout_threads):
                    inputs[e]['global_goal'] = self.short_term_goal[e]
                      ...
                      # 打印智能体目标到 CSV 文件
                    goal = inputs[e]['global_goal']
                   
                    print(f"The {e} goal is ,{goal[0]},{goal[1]}")  # 输出智能体编号和目标
